...
//	private String allowdSpeed;
	...
	// @NotBlank(message = "This filed can not be Empty.")
	// @Pattern(regexp = "^\\d+(\\.\\d+)*$",message = "This Filed content VERSION like 3.4.5")
	// @Size(max = 10,message = "This Filed content maximum length is 10")
