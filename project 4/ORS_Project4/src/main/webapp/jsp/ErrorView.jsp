...
<body>
	 ...
	 <form action="<%=ORSView.ERROR_CTL%>" method="get"> 
		<div align="center">
			<img src="<%=ORSView.APP_CONTEXT%>/img/HttpError.jpg" width="550" height="290">
			<h1 align="center" style="color: red">Ooops! Network Issue.....</h1>
			<font style="color: black; font-size: 25px"> <b>500</b> : Requested resources is not available </font>
